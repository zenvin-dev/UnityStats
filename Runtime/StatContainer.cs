...
namespace Zenvin.Stats {
    /// <summary>
    /// Component holding a collection of stat values.
    /// </summary>
    ...
    public sealed class StatContainer : MonoBehaviour {
        ...
        /// <summary>
        /// Gets the <see cref="StatInstance{T}.Value"/> of the instance associated with the given <paramref name="stat"/>.<br></br>
        /// If there is no such instance, <paramref name="fallback"/> is returned.
        /// </summary>
        /// <typeparam name="TValue"> The type of stat value. </typeparam>
        /// <param name="stat"> The stat whose associated instance to look for. </param>
        /// <param name="fallback"> Fallback value to return if no <see cref="StatInstance{T}"/> was found. </param>
        public TValue GetValue<TValue> (Stat<TValue> stat, TValue fallback = default) {
            if (TryGet (stat, out var instance))
        ...
        /// <param name="stat"> The stat whose associated instance to look for. </param>
        /// <param name="fallback"> Fallback value to return if no <see cref="StatInstance{T}"/> was found. </param>
        public TValue GetValue<TValue, TStat> (TStat stat, TValue fallback = default)
            where TStat : Stat<TValue> {
